    ...
    <div>
        ...
        <div className={className}>
            ...
            <div className="padding-div">
                ...
                <Button onClickProp={this.props.investInAI} name="Master Quantum Computer" picture="./pictures/quantum_computer.png" classNameButton={classNameQuantumComputerButton} cost={this.props.quantumComputerCost} classNameChild="info-quantum-computer-button" contentChild="This breakthrough computer is going to change our way to work. (+1000 Memory)" money={this.props.money} machineType="quantum-computer" currency='computational' lang={this.props.lang}/>
            </div>
        </div>    
  </div>)
