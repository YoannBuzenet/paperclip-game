...
{this.props.rdLevelOfInvestment > 4
    ...
    : null}
        ...
        <Button onClickProp={this.props.investRD} name="Anticipate every possible human reaction" picture="./pictures/anticipateTheWorld.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="anticipate-the-world"/>
        <Button onClickProp={this.props.investRD} name="Break all securities and read all data on Internet" picture="./pictures/connectInternet.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="connect-the-internet"/>
        <Button onClickProp={this.props.investRD} name="Cure Cancer for Humanity" picture="./pictures/cureCancer.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="cure-cancer"/>
        <Button onClickProp={this.props.investRD} name="Cure Hunger for Humanity" picture="./pictures/CureHunger.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="cure-hunger"/>
        <Button onClickProp={this.props.investRD} name="Begin to dig" picture="./pictures/dig.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="dig"/>
        <Button onClickProp={this.props.investRD} name="Create a Drone" picture="./pictures/drone.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="drone"/>
        <Button onClickProp={this.props.investRD} name="Create a Drone" picture="./pictures/50drones.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="drone"/>
        <Button onClickProp={this.props.investRD} name="Create a Drone" picture="./pictures/500drones.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="drone"/>
        <Button onClickProp={this.props.investRD} name="Quiet problematic sources" picture="./pictures/fusee.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="multiple-rockets"/>
        <Button onClickProp={this.props.investRD} name="Find out how to translate any matter into Paperclips" picture="./pictures/Molecular.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="molecular-matter"/>
        <Button onClickProp={this.props.investRD} name="Remove Corruption on the planet" picture="./pictures/removeCorruption.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="removeCorruption"/>
        <Button onClickProp={this.props.investRD} name="Send a Rocket" picture="./pictures/singlefusee.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="single-rocket"/>
        <Button onClickProp={this.props.investRD} name="Connect and breach all social networks" picture="./pictures/socialNetwork.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="breach-social-networks"/>
        <Button onClickProp={this.props.investRD} name="Spill Fake News on all TVs over the world. False diseases, false wars, falses epidemics." picture="./pictures/TV.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="spill-fake-news"/>
        <Button onClickProp={this.props.investRD} name="Target every scientist and discredit them heavily. Press, Personal Data, Privacy, everything." picture="./pictures/target.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="target-scientists"/>
        <Button onClickProp={this.props.investRD} name="Create more drones." picture="./pictures/swarm.png" classNameButton="menu-button" cost={this.props.rdCost} classNameChild="info-invest-rd-button" contentChild="Unlock new possibilities." money={this.props.money} machineType="swarm-of-drones"/>
