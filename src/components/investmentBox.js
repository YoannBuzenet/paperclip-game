...
class InvestmentBox extends Component{
    ...
    return (<div className="investment-box interface-div">
        ...
        <Button onClickProp={this.props.buyAMachine} money={this.props.money} name=" 5 Small Machines" machineProductivity={15} picture="./pictures/small-machinex5.png" classNameButton="small-machines5-button menu-button" cost={25} classNameChild="info-small-machinesx5-button" contentChild="Make even more (+ 15 paperclips per click)" createAndRemoveGraphicEffect={this.props.createAndRemoveGraphicEffect} isManual={true} machineQuantity={5} machineType="smallMachine" containsAnimation={true} id='small-Machine-Buttonx5' textAnimation="+15" animationIdTarget='ul-main-number' animationTypeOfElementCreated='li' animationCSSClass='graphInputOrange'/>
        : null}</div></div>

        {this.props.rdState > 2 
    ? <div>
        <div>
            <ButtonAutomaticData onClickProp={this.props.buyAMachine} picture="./pictures/automatic-machine.png" name="Automatic Machine" classNameButton="automatic-machines-button menu-button" cost={this.props.smallAutomaticMachineCost} classNameChild="info-automatic-machines-button" contentChild=" paperclips per second)" automaticProductivityPerMachine={this.props.productivyPerAutomaticMachine} isManual={false} machineQuantity={1} machineType="smallAutomaticMachine" machineProductivity={5}/>
        {this.props.rdState > 3 ? 
        <ButtonAutomaticData onClickProp={this.props.buyAMachine} picture="./pictures/automatic-machinex5.png" name="5 Automatic Machine" classNameButton="automatic-machines5-button menu-button" cost={50} classNameChild="info-automatic-machinesx5-button" contentChild=" paperclips per second)" automaticProductivityPerMachine={this.props.productivyPerAutomaticMachine} machineQuantity={5} isManual={false} machineType="smallAutomaticMachine" machineProductivity={5}/>
    : null}
    </div> 
    </div>
    : null}
    ...
    {this.props.rdState > 3 ? 
        ...
        <div><Button onClickProp={this.props.hireASalesman} name="Hire a salesman" picture="./pictures/salesman.png" classNameButton="salesman-button menu-button" cost={this.props.salesmanCost} classNameChild="info-salesman-button" contentChild="Develop your sales (+20 sales per second)" />
