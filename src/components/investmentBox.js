...
class InvestmentBox extends Component{
    ...
    <Button onClickProp={this.props.investInSoftware} name="Install Software" picture="./pictures/software-program.png" classNameButton="rd-install-software menu-button" cost={this.props.softwareCost} classNameChild="info-invest-rd-install-software" contentChild="With software, we will be able to manage all this production. (+2000 sales)" money={this.props.money}/>
        :null}  
    </div></div>}
...
{this.props.rdLevelOfInvestment > 4
    ...
    : null}
        ...
        <div>
            ...
            <Button onClickProp={this.props.investInAI} name="Create a Drone" picture="./pictures/50drones.png" classNameButton={classNameFiftyDroneButton} cost={this.props.droneCost*50} classNameChild="info-drone-button" contentChild="More drones." money={this.props.money} machineType="drone" machineQuantity={50} currency='paperclips'/>
