...
{this.props.rdLevelOfInvestment > 4
    ...
    : null}
        ...
        <div>
            ...
            <Button onClickProp={this.props.investInAI} name="Create a Drone" picture="./pictures/drone.png" classNameButton={classNameOneDroneButton} cost={this.props.droneCost} classNameChild="info-drone-button" contentChild="This drone will ship our paperclips to customers. (+1000 sales per second)" money={this.props.money} machineType="drone" machineQuantity={1} currency='paperclips' lang={this.props.lang}/>
            <Button onClickProp={this.props.investInAI} name="Create a Drone" picture="./pictures/x50.png" classNameButton={classNameFiftyDroneButton} cost={this.props.droneCost*50} classNameChild="info-drone-button" contentChild="More drones." money={this.props.money} machineType="drone" machineQuantity={50} currency='paperclips' lang={this.props.lang}/>
            <Button onClickProp={this.props.investInAI} name="Create a Drone" picture="./pictures/x500.png" classNameButton={classNameFiveHundredDroneButton} cost={this.props.droneCost*500} classNameChild="info-drone-button" contentChild="More drones." money={this.props.money} machineType="drone" machineQuantity={500} currency='paperclips' lang={this.props.lang}/>
        </div>
        <div>
             <Button onClickProp={this.props.investInAI} name="Improve Drone" picture="./pictures/improveDrones.png" classNameButton={classNameImproveDroneButton} cost={this.props.ImprovedroneCost} classNameChild="info-improve-drone-button" contentChild="Increase Computational Power of the drones." money={this.props.money} machineType="improve-drone" currency='computational' lang={this.props.lang}/>
