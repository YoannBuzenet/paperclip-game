...
class InvestmentBox extends Component{
    ...
    {this.props.salesLevelOfInvestment > 4 &&
     <div><h3>RESEARCH & DEVELOPMENT</h3>
        ...
        {this.props.rdLevelOfInvestment > 4 && <Button onClickProp={this.props.buyOffice} name="Buy new offices" picture="./pictures/new_office.png" classNameButton="office-button menu-button investment-button" cost={this.props.officeCost} classNameChild="info-buy-office-button" contentChild="Hire more sales" money={this.props.money} />}
    

    {this.props.rdLevelOfInvestment > 5 && this.props.softwareLevelOfInvestment < 1 ?
    <Button onClickProp={this.props.investInSoftware} name="Install Software" picture="./pictures/software-program.png" classNameButton="rd-install-software menu-button investment-button" cost={this.props.softwareCost} classNameChild="info-invest-rd-install-software" contentChild="With software, we will be able to manage all this production. (+2000 sales)" money={this.props.money}/>
        :null}  
    </div></div>}

{this.props.rdLevelOfInvestment > 4
    ? <div><h3>EXPANSION</h3><div>
    <ButtonAutomaticData onClickProp={this.props.buyAMachine} money={this.props.money} name="Factory" picture="./pictures/factory.png" classNameButton="factory-button menu-button investment-button" cost={this.props.factoryCost} classNameChild="info-buy-factory-button" contentChild=" paperclips per second)" isManual={false} machineType="factory" machineProductivity={10000} machineQuantity={1} automaticProductivityPerMachine={this.props.productivyPerAutomaticMachine}/></div></div>
    : null}
    </div>
        </div>}
        ...
        {this.props.cloudConnectionEstablished && <div className={className}>
            <h2 className="AI-context">EXECUTION</h2>
            <div className="padding-div">
        ...
        <div>
            ...
            <Button onClickProp={this.props.investInAI} name="Create a Drone" picture="./pictures/x50.png" classNameButton={classNameFiftyDroneButton} cost={this.props.droneCost*50} classNameChild="info-drone-button" contentChild="More drones." money={this.props.money} machineType="drone" machineQuantity={50} currency='paperclips'/>
        ...
        <div>
             ...
             <Button onClickProp={this.props.investInAI} name="Drone can now build factories." picture="./pictures/programDroneToBuildFactories.png" classNameButton={classNameDroneBuildFactoryButton} cost={this.props.droneCanCreateFactoryCost} classNameChild="info-drone-can-build-factory-button" contentChild="Program Drones to be able to build factories." money={this.props.money} machineType="drones-can-build-factories" currency='computational'/>
             <Button onClickProp={this.props.investInAI} name="Increase Machines Productivity" picture="./pictures/factoryIncrease.png" classNameButton={classIncreaseFactoryProductivityButton} cost={this.props.increaseFactoryCost} classNameChild="info-drone-can-build-factory-button" contentChild="Improve Drone network and abilities to build more factories." money={this.props.money} machineType="increaseFactoryProductivity" currency='computational'/>
        </div>
        <div>
        ...
        <div>
            ...
            <Button onClickProp={this.props.investInAI} name="Begin to dig" picture="./pictures/dig.png" classNameButton={classDigHasStartedButton} cost={this.props.digCost} classNameChild="info-dig-bro-button" contentChild="Install gigantic mines everywhere. Need matter." money={this.props.money} machineType="dig" currency='computational'/>
        </div>
        <div>
