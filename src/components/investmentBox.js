...
class InvestmentBox extends Component{
    ...
    {this.props.salesLevelOfInvestment > 3 &&
...
{this.props.rdLevelOfInvestment > 4
    ...
    : null}
        ...
        <div>
             <Button onClickProp={this.props.investInAI} name={this.props.text.gameButtons.improveDrone} picture="./pictures/improveDrones.png" classNameButton={classNameImproveDroneButton} cost={this.props.ImprovedroneCost} classNameChild="info-improve-drone-button" contentChild={this.props.text.gameButtons.improveDroneContent} money={this.props.money} machineType="improve-drone" currency='computational' lang={this.props.lang} totalComputationalPowerAccumulated={this.props.totalComputationalPowerAccumulated}/>
             <Button onClickProp={this.props.investInAI} name={this.props.text.gameButtons.improveFactories} picture="./pictures/droneFactory.png" classNameButton={classNameImproveFactoryButton} cost={this.props.improveFactoryToCreateDroneCost} classNameChild="info-improve-factory-button" contentChild={this.props.text.gameButtons.improveFactoriesContent} money={this.props.money} machineType="improve-factory" currency='computational' lang={this.props.lang} totalComputationalPowerAccumulated={this.props.totalComputationalPowerAccumulated}/>
             <Button onClickProp={this.props.investInAI} name={this.props.text.gameButtons.droneCanBuildFactoriesName} picture="./pictures/programDroneToBuildFactories.png" classNameButton={classNameDroneBuildFactoryButton} cost={this.props.droneCanCreateFactoryCost} classNameChild="info-drone-can-build-factory-button" contentChild={this.props.text.gameButtons.droneCanBuildFactoriesContent} money={this.props.money} machineType="drones-can-build-factories" currency='computational' lang={this.props.lang} totalComputationalPowerAccumulated={this.props.totalComputationalPowerAccumulated}/>
             <Button onClickProp={this.props.investInAI} name={this.props.text.gameButtons.increaseMachineProductivyName} picture="./pictures/factoryIncrease.png" classNameButton={classIncreaseFactoryProductivityButton} cost={this.props.increaseFactoryCost} classNameChild="info-drone-can-build-factory-button" contentChild={this.props.text.gameButtons.increaseMachineProductivyContent} money={this.props.money} machineType="increaseFactoryProductivity" currency='computational' lang={this.props.lang} totalComputationalPowerAccumulated={this.props.totalComputationalPowerAccumulated}/>
        </div>
        <div>
            <ButtonAutomaticData onClickProp={this.props.buyAMachine} money={this.props.money} name={this.props.text.gameButtons.factoryPaperclipName} picture="./pictures/factory.png" classNameButton={classNameFactoryButton} cost={100000} classNameChild="info-buy-factory-button" contentChild={this.props.text.gameButtons.investmentAutomaticMachineContent} isManual={false} machineType="factory" machineProductivity={10000} machineQuantity={1} automaticProductivityPerMachine={this.props.productivyPerAutomaticMachine} currency='paperclips' lang={this.props.lang}/>
        ...
        <div>
            <Button onClickProp={this.props.investInAI} name={this.props.text.gameButtons.cureCancerForHumanity} picture="./pictures/cureCancer.png" classNameButton={classNameCancerCuredButton} cost={this.props.cureCancerCost} classNameChild="info-cure-cancer-button" contentChild={this.props.text.gameButtons.cureCancerForHumanityContent} money={this.props.money} machineType="cure-cancer" currency='computational' lang={this.props.lang} totalComputationalPowerAccumulated={this.props.totalComputationalPowerAccumulated}/>
            <Button onClickProp={this.props.investInAI} name={this.props.text.gameButtons.cureHungerForHumanityName} picture="./pictures/CureHunger.png" classNameButton={classNameHungerCuredButton} cost={this.props.rdCost} classNameChild="info-cure-hunger-button" contentChild={this.props.text.gameButtons.cureHungerForHumanityContent} money={this.props.money} machineType="cure-hunger" currency='computational' lang={this.props.lang} totalComputationalPowerAccumulated={this.props.totalComputationalPowerAccumulated}/>
            <Button onClickProp={this.props.investInAI} name={this.props.text.gameButtons.removeCorruptionOnPlanetName} picture="./pictures/removeCorruption.png" classNameButton={classRemoveCorruptionButton} cost={this.props.removeCorruptionCost} classNameChild="info-remove-corruption-button" contentChild={this.props.text.gameButtons.removeCorruptionOnPlanetContent} money={this.props.money} machineType="removeCorruption" currency='computational' lang={this.props.lang} totalComputationalPowerAccumulated={this.props.totalComputationalPowerAccumulated}/>
        </div>
        <div>
